  ...
  return {
    ...
    providers: {
      shopify: {
        ...
        declared_write_scope_family: [],
        implemented_operations: ["reporting", "order lookup", "product recommendation"],
        exposed_write_tools: [],
        autonomy_mode: "read_only_until_bounded_shopify_write_capabilities_are_implemented",
        verification_level: "configuration_and_declared_scopes_only",
        missing_for_operations: ["No generic bounded Shopify Admin write capability is exposed yet. Frontend code changes use the GitHub PR workflow."],
      },
      klaviyo: {
