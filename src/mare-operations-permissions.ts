...
export function buildOperationsPermissionsAudit(env: OperationsPermissionsEnv): JsonObject {
  ...
  return {
    ...
    policy: {
      model: "least_privilege_with_explicit_execution_approval",
    ...
    providers: {
      shopify: {
        ...
        missing_for_operations: ["No Shopify Admin write tool is exposed. Frontend changes use GitHub PR workflow instead."],
      },
      klaviyo: {
